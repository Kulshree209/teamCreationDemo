...
Then(/^Check Login$/, async () => {
   ...
   await driver.wait(until.elementLocated(By.xpath("//*[@text='Logout']"), 1000));
    ...
    /*await driver.wait(until.elementLocated(By.xpath("//*[@text='Login']"), 1000));
    var loginElements = await driver.findElements(By.xpath("//*[@text='Login']"));
    assert.notEqual(loginElements.length, 0);
    console.log('Then: Checking if login suceeds... End');*/
